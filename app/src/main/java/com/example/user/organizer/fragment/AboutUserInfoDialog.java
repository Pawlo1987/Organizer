...
//---------------------- Фрагмент с диалогом подробнее о пользователе -------------------
public class AboutUserInfoDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        formatPartOfTheText("Логин:", 6);
        formatPartOfTheText("Пароль:", 7);
        formatPartOfTheText("Имя:", 4);
        formatPartOfTheText("Телефон:", 8);
        formatPartOfTheText("Город:", 6);
        formatPartOfTheText("E-mail:", 7);
